 ...
 * @author chris
 */
public class EDRProductosMenosDemandados extends javax.swing.JPanel {

    /**
     * Creates new form EDRProductosMenosDemandados
     */
    public EDRProductosMenosDemandados() {
        initComponents();
        consultar();
    ...
    void graficaProductosMayorDemandados(){
     // Grafica de barras
        ...
        JFreeChart graficoBarra = ChartFactory.createBarChart3D(
                "SUMA POR CATEGORIA DE LOS PRODUCTOS MENOR DEMANDADOS",
        ...
        panel.setPreferredSize(new Dimension (570, 572));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PRODUCTOS CON MENOR DEMANDA");
        ...
        jPanel1.add(Grafica, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 64, 570, -1));

        jLabel3.setFont(new java.awt.Font("HP Simplified", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setText("TABLA");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(624, 41, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 70, -1, 560));
